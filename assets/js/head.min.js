(function (a) {
  ...
  (j =
    ...
    /(msie) ([\w.]+)/.exec(j) ||
    (!/compatible/.test(j) && /(mozilla)(?:.*? rv:([\w.]+))?/.exec(j)) ||
    []),
    j[1] == "msie" && ((j[1] = "ie"), (j[2] = document.documentMode || j[2])),
    f(j[1]),
    (i.browser = { version: j[2] }),
    (i.browser[j[1]] = !0);
  if (i.browser.ie) {
    f("ie" + parseFloat(j[2]));
  ...
  (function (a) {
    ...
    var b = a.documentElement,
      ...
      h = {},
      i =
        a.createElement("script").async === !0 ||
